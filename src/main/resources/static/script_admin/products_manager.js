        ...
        fetch("http://localhost:8080/api/bags/search/keyword?keyword=".concat(keyword))
            ...
            if (data) {
                ...
                for (var i = 0; i < data.length; ++i) {
                    ...
                    searchOrderSuggesstionContainer.innerHTML +=
                        "<a href=\"\" class=\"order-search-suggesstion\">\n\t\t\t\t\t\t\t<svg xmlns=\"http://www.w3.org/2000/svg\" width=\"24\" height=\"24\" style=\"fill: rgba(0, 0, 0, 1);\"\n\t\t\t\t\t\t\tclass=\"\">\n\t\t\t\t\t\t\t\t<path d=\"M10 18a7.952 7.952 0 0 0 4.897-1.688l4.396 4.396 1.414-1.414-4.396-4.396A7.952 7.952 0 0 0 18 10c0-4.411-3.589-8-8-8s-8 3.589-8 8 3.589 8 8 8zm0-14c3.309 0 6 2.691 6 6s-2.691 6-6 6-6-2.691-6-6 2.691-6 6-6z\"></path>\n\t\t\t\t\t\t\t</svg>\n\t\t\t\t\t\t\t<span class=\"search-order-cusPhone\">".concat(bagCate['bagCateID'], "</span>\n\t\t\t\t\t\t\t<span class=\"search-order-orderDate\">").concat(bagCate['name'], "</span>\n\t\t\t\t\t\t\t<span class=\"search-order-orderDate\">").concat(bagCate['brand'], "</span>\n\t\t\t\t\t\t</a>");
                }
            }
        });
    });
